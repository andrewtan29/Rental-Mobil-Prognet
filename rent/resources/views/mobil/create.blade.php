    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900">
          ...
          <h2 class="text-xl font-semibold mb-5">Tambah Mobil</h2>

          <form class="max-w-xl" method="POST" action="{{ route('mobil.create') }}">
            @csrf
            ...
            <div class="mb-5">
              ...
              <input id="nama" name="nama"
                ...
                placeholder="Masukan nama mobil" required value="{{ old('nama') }}" />
              @error('nama')
            ...
            <div class="mb-5 mt-4">
              ...
              <input id="harga_sewa" name="harga_sewa" type="number"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Masukan harga sewa mobil" required value="{{ old('harga_sewa') }}" />
              @error('harga_sewa')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
              @enderror
            </div>
            ...
            <div class="mb-5 mt-4">
              ...
              <input id="plat_nomor" name="plat_nomor" type="text"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Masukan plat nomor mobil" required value="{{ old('plat_nomor') }}" />
              @error('plat_nomor')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
              @enderror
            </div>
            ...
            <div class="mb-5 mt-4 hidden">
              ...
              <input id="jumlah" name="jumlah" type="number"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Masukan jumlah mobil" required value="1" />
              @error('jumlah')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
              @enderror
            </div>
